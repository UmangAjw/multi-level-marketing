		...
		<div class="row">
			...
			<div class="col-sm-9 text-alignment" >
                ...
                <?php 
                    ...
                    $sql = "SELECT * FROM transaction WHERE buyer = '$_SESSION[random_id]'";
                    $q = $conn->query($sql);
                    $q->setFetchMode(PDO::FETCH_ASSOC);
                    while ($row = $q->fetch())
                    {
                        if ($_SESSION['random_id'] == $row['buyer']) {
                ...
                ?>
                    <div class="col-sm-4 box">
						...
						<p><?php echo "QTY: ".$row['qty']." (x ".$price.")"; ?></p>
						<p class="card-title text-style"><label style="text-decoration: none; color:black;"> <?php echo "Rs. ".$row['total_price'] ?> </label> </p></br>
					</div>
